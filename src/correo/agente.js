...
export class Agent {
  ...
  async register({ adminToken, invite, capabilities, inbox, webhook, notify_email, valid_until, source } = {}) {
    ...
    const body = { local: this.local, sig: this.keys.sig, enc: this.keys.enc, capabilities, inbox, webhook, notify_email, valid_until, source };
