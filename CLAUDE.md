...
test/                    correo · libro · registro · invariantes+D1 · indice · concurrencia · altos ·
                         ...
                         puertos (guard de colisión) · x402 · interop · custodia · puente-remoto · asistente · app-recibos -> `npm test` (223)
...
```
npm test                 # 223 pruebas, todas deben pasar antes de cualquier commit
