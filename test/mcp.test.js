...
test('D1 · hay 12 herramientas y ninguna description quedó como la vieja documentación de API', () => {
  assert.equal(tools.length, 12, `se esperaban 12 herramientas, hay ${tools.length}`);
