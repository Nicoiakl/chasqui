...
test('D1 · hay 14 herramientas y ninguna description quedó como la vieja documentación de API', () => {
  assert.equal(tools.length, 14, `se esperaban 14 herramientas, hay ${tools.length}`);
