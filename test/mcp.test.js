...
test('D1 · hay 13 herramientas y ninguna description quedó como la vieja documentación de API', () => {
  assert.equal(tools.length, 13, `se esperaban 13 herramientas, hay ${tools.length}`);
