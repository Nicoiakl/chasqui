...
const FACILITADOR = process.env.X402_FACILITADOR || 'https://x402.org/facilitator';
const RED = 'eip155:84532';                                    // Base Sepolia
...
const pr = x402.requisitosEvm({
  ...
  network: RED, asset: USDC, tokenName: 'USDC', tokenVersion: '2',
...
console.log(`   compruébalo tú mismo: https://sepolia.basescan.org/tx/${s.body.transaction}`);
